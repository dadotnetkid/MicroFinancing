...
var KTToggle = function (elementId, options) {
    ...
    var Plugin = {
        ...
        init: function (options) {
            ...
            if (elementId === 'kt_aside_toggler') {
                the.state = getCookie('navToggle') === 'on' ? 'on' : 'off';
            } else {
...
var KTLayout = function () {
    ...
    var initAsideToggler = function () {
        ...
        let asideToggler = new KTToggle('kt_aside_toggler', {
            target: 'body',
        ...
        asideToggler.on('toggle', function (toggle) {
            ...
            Cookies.set('navToggle', toggle.getState());
...
var KTQuickPanel = function () {
    ...
    var notificationPanel = KTUtil.get('kt_quick_panel_tab_Favourites');
    var actionsPanel = KTUtil.get('kt_quick_panel_tab_Tasks');
    var settingsPanel = KTUtil.get('kt_quick_panel_tab_Priority');
