...
namespace MicroFinancing.MobileApp.Components.Pages.Customers.Details;
...
public partial class AddPayment
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender)
        {
            var res = await CustomersClient.GetCustomerIdAsync(CustomerId);
    ...
    public CustomerDetailDTM CustomerDetail { get; set; } = new();
